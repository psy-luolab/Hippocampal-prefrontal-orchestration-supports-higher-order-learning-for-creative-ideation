...
for s = 1:length(subjects)
    ...
    data_HSC_msk1=fullfile(sub_path,'glm_T_stats_HSC.nii');
  ...
  %
    ...
    %% mask2,hsc
    data_HSC_msk2=fullfile(sub_path,'glm_T_stats_HSC.nii');
  ...
  % 
    ...
    %% msk1,lsc
    data_LSC_msk1=fullfile(sub_path,'glm_T_stats_LSC.nii');
 ...
 %
    ...
    %% msk2,lsc
    data_LSC_msk2=fullfile(sub_path,'glm_T_stats_LSC.nii');
