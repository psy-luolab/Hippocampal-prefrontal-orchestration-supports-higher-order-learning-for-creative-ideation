...
study_path='H:\GJXX_1_reanalysis\jiaocha_vs_nojiaocha\rca\patterns'; 
...
for s = 1:length(subjects)
    ...
    data_HSC_msk1=fullfile(sub_path,'glm_T_HSC_C.nii');
  ...
  %
    ...
    %% mask2,hsc
    data_HSC_msk2=fullfile(sub_path,'glm_T_HSC_C.nii');
  ...
  % 
    ...
    %% msk1,lsc
    data_LSC_msk1=fullfile(sub_path,'glm_T_LSC_C.nii');
 ...
 %
    ...
    %% msk2,lsc
    data_LSC_msk2=fullfile(sub_path,'glm_T_LSC_C.nii');
