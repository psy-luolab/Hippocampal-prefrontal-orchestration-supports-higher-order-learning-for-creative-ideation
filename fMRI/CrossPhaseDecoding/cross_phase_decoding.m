% Cross-phase decoding analysis: vlPFC generalizable decoding from learning ¡ú creating.
%- Train SVM on learning-phase data
%- Test on creating-phase data
%- ROI-based decoding accuracy
%- Correlation with creative performance
...
for i_subj=1:39
    ...
    cosmo_map2fmri(p, ...
        fullfile(output_path,'svm.nii'));
end

% using the function: cosmo_balance_partitions from cosmoMvpa
function acc = ccgp_using_svm(ds,measure_args)
acc = struct();
